...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Gay Triangle", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (fabs(lastYPosition) > 1.0f) {
			speedY = -speedY;
		}

		translate[12] = elapsedSeconds * speedX + lastXPosition;
		translate[13] = elapsedSeconds * speedY + lastYPosition;
		...
		translate[12] = elapsedSeconds * speed + lastXPosition;
		lastPosition = translate[12];
		*/
